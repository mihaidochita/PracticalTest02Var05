...
public class ServerThread extends Thread {
	...
	private HashMap<String, StoredValue> data = null;
	...
	public ServerThread(int port) {
		...
		this.data = new HashMap<String, StoredValue>();
	}
	...
	public synchronized void setData(String key, StoredValue storedValue) {
		this.data.put(key, storedValue);
	}
	
	public synchronized HashMap<String, StoredValue> getData() {
		return data;
	}
